...
type IconName = "home" | "students" | "courses" | "notes" | "schedule" | "interview" | "logout" | "search";
    ...
    <div className="school-app">
      <header className="school-navbar">
        <button className="school-logo" onClick={() => navigate("/")} aria-label="Ir al inicio">
          <span className="school-logo-mark">EA</span>
        ...
        <nav className="school-nav" aria-label="Navegación principal">
          ...
          <button className="nav-item" onClick={() => navigate("/entrevista")}><Icon name="interview" /> <span>Entrevista</span></button>
        </nav>
      ...
      <main className="dashboard-main">
        <section className="welcome-panel">
          ...
          <p className="student-greeting">Hola <strong>{studentName}</strong>, aquí puedes consultar y gestionar la información de tu vida académica.</p>
          ...
          <div className="dashboard-actions">
            ...
            <button className="dashboard-card" onClick={() => navigate("/entrevista")}><span className="dashboard-icon"><Icon name="interview" /></span><strong>Entrevista</strong><small>Solicitar entrevista</small></button>
          </div>
        </section>
      </main>
    </div>
